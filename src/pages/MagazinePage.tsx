...
const magazineLinks = [
  { title: "Magazine 2023-24", url: getPDFUrl("pdf/magazine(2324).pdf") },
  { title: "Magazine 2022-23", url: getPDFUrl("pdf/magazine(2223).pdf") },
  { title: "Magazine 2021-22", url: getPDFUrl("pdf/maganize(2122).pdf") },
];
